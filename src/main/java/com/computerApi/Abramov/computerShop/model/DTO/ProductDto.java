...
public class ProductDto {
    ...
    public ProductDto(String seriesNumber, String manufacturer, Long price, Long count, Type type, Integer diagonal, Long amount, ComputerType computerType, LaptopType laptopType) {
